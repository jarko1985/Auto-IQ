...
// A vendor applicant is still a plain CUSTOMER account until their
// application is approved (see features/vendors/service.ts) — the real
// VendorSidebar requires an existing org and redirects here when one
// doesn't exist yet, so onboarding shares the customer portal's chrome
// instead (its own secondary nav already links to /vendor/onboarding).
